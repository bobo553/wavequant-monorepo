...
test("a completed manual backtest updates the matching watchlist row", async ({ page }) => {
    ...
    await page.addInitScript(() => localStorage.setItem("wavequant.watchlists.auto-backtest.v1", "false"));
    ...
    let submitted = 0;
    let releaseBacktest;
    const backtestHold = new Promise((resolve) => { releaseBacktest = resolve; });
