...
- `MONOREPO-024` 已完成：末跌高被首个同级已确认高点严格突破后，水平虚线延长到该突破 K 线；等价触碰不算突破。
...
- 新增“各级末跌高”独立图层：标签落在图窗最低已确认 L 左侧最近的同级已确认 H；未突破时水平虚线止于该 L，突破后延长到低点之后首个严格更高的同级已确认 H；没有已确认结构的级别不补画，点击标签可查看来源、确认日、突破点和完整定义。
