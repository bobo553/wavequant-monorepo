"""One-shot offline operations pipeline. No daemon, network or live orders.
...
from .event_store import EventStore, canonical
from .experiment_registry import environment_snapshot
from .io import load_bars
from .operational_store import (workspace_lock, identifier, now, run_states,
