...
from .integrated_strategy import SystemStrategy, generate_system_signals, pivot_history
from .operational_store import run_states, alert_states
from .operations import verify_run
from .n_shape import project_n_targets, ValueDomain
from .price_action import Direction
from .project_paths import project_path
from .lecture_drawing import lecture_drawing
from .lecture_trend import reversal_trends
from .secondary_trend import secondary_trends
from .tertiary_trend import tertiary_trends
from .stock_backtest import single_stock_result
from .trade_evidence import result_markers
from .strategy_profiles import research_profile, PROFILE_ID, hierarchical_profile, HIERARCHICAL_PROFILE_ID
from .strategy_profiles import whole_wave_profile, WAVE_PROFILES
...
VARIANTS.update(
    {
        "lecture_v3": "整段双买点 V3 · 深 >1/2 / 收盘 ≤1/3",
...
class ChartRepository:
    def __init__(self, root, tdx_root=None):
        from .tdx_browser import TdxBrowser
        ...
        self.refresh()
        from .buy_scanner import BuyScanner
    ...
    def bars(self, rid):
        ...
        from .io import _validate_bar, _parse_bool
    ...
    def render_theory(self, bars, config, result, asof, *, geometry=None):
        ...
        return dict(
            ...
            **geometry,
            ...
            engine_sha256=fingerprint(Path(__file__).with_name("integrated_strategy.py")),
