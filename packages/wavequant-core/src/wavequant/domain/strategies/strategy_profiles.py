...
def whole_wave_profile(legacy,variant='lecture_v3'):
    ...
    config['definition'].update(
        ...
        wave_target_upper_shadow_exit='entry_n_reached_two_t_five_top_or_ten_full_upper_shadow_ge_half_range_cumulative_80_same_close_then_first_later_lower_close_full_clear',
