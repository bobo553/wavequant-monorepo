...
from .integrated_strategy import SystemStrategy, SystemResult, generate_system_signals
from .model import Bar, Signal
from .artifact_cache import ArtifactCache
from .stock_backtest import single_stock_result
from .tdx import read_day, read_actions, adjust_rows
...
class TdxBacktester:
    ...
    def run(self,symbol,start,asof,strategy,execution,*,_screening=None):
        ...
        with self.artifacts.lock(self.artifacts.key('stock',symbol)):
            ...
            if summary is None:
                from .buy_scanner import buy_match
                from .screening_funnel import funnel
    ...
    def _view(self,key,inputs,bars,result,sessions):
        ...
        from .visualization import metrics_at
