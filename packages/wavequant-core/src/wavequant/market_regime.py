"""Six regimes for one causally completed N episode, not trading instructions.
...
from .n_shape import MilestoneBasis, NSetup, NStatus, observe_n
from .price_action import Direction, ResistanceEvidence, ShadowPolicy, observe_resistance
