"""Causal frozen bearish context -> alternation -> bullish entry permission."""
from dataclasses import dataclass

from .price_action import AttackBasis
from .trend_structure import (StructuralTrend, TransitionStage, observe_structure,
