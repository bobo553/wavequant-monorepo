"""Auditable offline event pipeline. Future suffixes never change dated signals.
...
from .polyline import LinePoint, PointKind, ReversalPoint, observe_polyline, observe_bar_relations
from .n_shape import NSetup, PivotRef, BoxAnchorMode, MilestoneBasis, observe_n
from .price_action import Direction, ShadowPolicy, AttackBasis
from .market_regime import MarketRegime, RegimePolicy, WaveBoundary, observe_market_regime
from .control_bar import observe_control_bar
from .trend_structure import observe_structure
from .bull_eligibility import bull_permission_history
from .squeeze_state import observe_squeeze_resumption
from .wave_strength import StrengthScale, measure_strength
from .washout import WashoutPolicy, WashoutStage, observe_washout
from .market_turn import (RegimeContext, TurnSetup, TurnPolicy, TurnThreshold, freeze_minor_line, observe_market_turn)
