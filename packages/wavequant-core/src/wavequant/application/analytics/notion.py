"""Run fixed-hypothesis research from a local, reproducible note inventory."""
...
from wavequant.domain.market_structure.structure import StructureConfig, structural_signals
