"""Run reproducible splits, baselines, ablations, and execution-cost stress tests."""
...
from wavequant.domain.strategies.strategy import breakout_signals, generate_signals
