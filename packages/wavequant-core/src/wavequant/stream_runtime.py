"""Restartable causal strategy adapter. No second copy of trading theory.
...
from .integrated_strategy import generate_system_signals
from .io import _validate_bar
